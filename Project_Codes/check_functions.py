...
class CheckInputData:
    ...
    def number_of_items(self, object_one,
                        object_two):  # I guess there will be always the same number after the first looping, so we have to check the files in the folder not the resulting lists
